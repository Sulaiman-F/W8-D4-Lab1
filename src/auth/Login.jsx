...
function Login() {
  const API = "https://683ff0e65b39a8039a563029.mockapi.io/Users";
      ...
      <div className="flex flex-col md:flex-row items-center justify-center h-screen bg-gray-100">
        <div className="hidden md:flex flex-col gap-y-5 items-center justify-center bg-gradient-to-bl from-violet-600 to-violet-800 text-white h-full w-1/2 rounded-r-4xl">
          ...
          <p className="text-center text-lg w-3/4">
            Welcome back to our platform! Here, you can manage your homework and
            assignments with ease. Stay organized, track your progress, and
            collaborate with peers. Let's get started on your academic journey!
          </p>
        </div>
